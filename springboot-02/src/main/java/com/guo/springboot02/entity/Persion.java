...
public class Persion {
    ...
    public Persion(String userName, Boolean boss, Date birth, Integer age,
                   Pet pet, String[] interests, List<String> animal,
                   Map<String, Object> score, Set<Double> salarys, Map<String, List<Pet>> allPets) {
